...
const allword = ["AUTOGRAPHE","MACHOIRE","PRODUIRE","FESTIVAL","ACUPUNCTURE","MONSTRE",
              "ANTENNE","AILES","CHATON","PAYSAGE","SINGE","COUPABLE",
              "DEFAITE","SUPERIEUR","RONRONNER","RELIGION","MONUMENT",
              "INTERCEPTION","TRANSCENDANCE","LACONIQUE","NIMBE","SYNODE","ACCULTURATION",
              "HYPERGAMIE","SYCOPHANTE","DELIQUESCENCE","PLOUTOCRATIE","GEHENNE","PANOPTIQUE"]
        ...
        <div className="keyboard">
          { keyboard.map((letter, index) => (
            <Keyboard
              ...
              feedback={this.getFeedback(letter) ? "gray" : "#2FA3FF"}
              />
          ))}
        </div>
      </div>
